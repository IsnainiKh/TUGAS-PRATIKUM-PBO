...
public class View extends JFrame implements ActionListener{
    ...
    View(){
        ...
        lJudul.setBounds(100,0,200,20);
        lPanjang.setBounds(10,30,150,20);
        fPanjang.setBounds(90, 30, 150, 20);
        lLebar.setBounds(10,70,150,20);
        fLebar.setBounds(90, 70, 150, 20);
        lTinggi.setBounds(10,110,150,20);
        fTinggi.setBounds(90, 110, 150, 20);
        lHasil.setBounds(50, 140, 150, 20);
        bHitung.setBounds(45, 350, 150, 50);
        bReset.setBounds(200, 350, 150, 50);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == bHitung) {
            ...
            try{
                ...
                lLuasP.setText      ("Luas Persegi   : " + Double.toString(balok.luas())); add(lLuasP);
                lLuasP.setBounds(30, 170, 200, 30);
                lKelilingP.setText  ("Keliling Persegi      : " + Double.toString(balok.keliling())); add(lKelilingP);
                lKelilingP.setBounds(30, 210, 200, 30);
                lVolumeB.setText    ("Volume Balok    : " + Double.toString(balok.volume())); add(lVolumeB);
                lVolumeB.setBounds(30, 250, 200, 30);
                
                lLuasPer.setText    ("Luas Permukaan Balok  : " + Double.toString(balok.luasPermukaan())); add(lLuasPer);
                lLuasPer.setBounds(30, 290, 200, 30);
